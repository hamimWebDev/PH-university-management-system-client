...
export const studentDummyData = {
  ...
  student: {
    ...
    // Academic INFO
    admissionSemester: "66cdb7f76742e9f676065562",
    academicDepartment: "66cde6836742e9f676065611",
  },
};
      ...
      <Col span={24}>
        <PHFrom onSubmit={onSubmit}>
          ...
          <Row gutter={8}>
            ...
            <Col span={24} md={{ span: 12 }} lg={{ span: 8 }}>
              <PHSelect name="gender" options={genderOption} label="Gender" />
            </Col>
            <Col span={24} md={{ span: 12 }} lg={{ span: 8 }}>
